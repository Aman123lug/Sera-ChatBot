...
#     converstion_factor = fetch_convertion_factor(source_currency, target_currency)
#     final_amount = amount * converstion_factor
#     print(final_amount)
#     response = {
...
#     # print(responses)
#     # return responses['{}_{}'.format(source, target)]
